...
| [`littleman/MNIST.md`](littleman/MNIST.md) | **a machine that learns** — a CNN trained on MNIST, plotting its own loss and accuracy curves on two LM-75 panels; 80–82% validation, ~4 min an epoch |
